    ...
    <Container>
      <Content>
        ...
        <Row>
          ...
          <Button color='secondary' onClick={() => signalOperation('-')} image='./assets/minus.svg' alt='SUBTRAIR'/>
        </Row>
        <Row>
          ...
          <Button onClick={() => signalOperation('+')} image='./assets/plus.svg' alt='SOMAR'/>
        </Row>
        <Row>
          <Button color='secondary' onClick={() => handleAddNumber('0')} title='0'/>
          <Button color='secondary' onClick={() => signalOperation('.')} title='.'/>
          <Button color='secondary' onClick={handleEraseNumber} image='./assets/backspace.svg' alt='RESULTADO'/>
